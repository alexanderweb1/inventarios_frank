          ...
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <form id="form1" name="form1" method="post" action="ubicacion_acc.php">
              <div class="form-group">
                <label for="usuario" class="sr-only">Nombre de Ubicación:</label>
                <input required name="nombre" id="nombre" class="form-control" value="<?php echo $nombre; ?>" placeholder="Ingrese el nombre de la ubicación">
              ...
              <div class="form-group mb-4">
                ...
                <textarea required id="descripcion" name="descripcion" rows="4" cols="50" placeholder="Ingrese la descripción de la ubicacion"><?php echo $descripcion; ?></textarea>
              </div>
